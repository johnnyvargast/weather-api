...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-1i#+p5(jzgt0y#-yh3sl)5j69lhwo0_m655hj6(fqg78pv5y+p')
...
# Weather API
WEATHER_API_KEY = env('WEATHER_API_KEY', default='542ffd081e67f4512b705f89d2a611b2')
